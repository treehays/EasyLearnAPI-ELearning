...
{
    /// <inheritdoc />
    public partial class Testts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Skill = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Interest = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VerifyBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VerifyOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleDuration = table.Column<TimeSpan>(type: "time", nullable: false),
                    SequenceOfModule = table.Column<int>(type: "int", nullable: false),
                    VideoSequence = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReferrenceNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthorizationUri = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    AccessExpiration = table.Column<DateTime>(type: "datetime2", nullable: true),
