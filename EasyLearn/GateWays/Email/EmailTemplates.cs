...
{
    public static string ConfirmationEmailTemplate(EmailSenderDetails model, string baseUrl) => "for dotnet6.0";
    /*
...
*/
    ...
    public static string EnrollmentEmailTemplate(EmailSenderDetails model, string baseUrl) => $"for dotnet6.0";

    public static string CourseCompletionEmailTemplate(EmailSenderDetails model, string baseUrl) => $"for dotnet6.0";

    public static string WithdrawalComfirmationEmailTemplate(EmailSenderDetails model, string baseUrl) => $"for dotnet6.0";

    public static string PasswordRessetEmailTemplate(EmailSenderDetails model, string baseUrl) => $"for dotnet6.0";
}
